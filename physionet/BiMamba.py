...
class BiMambaEncoder(nn.Module):
    # taken from here: https://github.com/Huangmr0719/BiMamba/blob/main/BiMamba.py
...
class BiMambaConcatEncoder(nn.Module):
    # taken from here: https://github.com/Huangmr0719/BiMamba/blob/main/BiMamba.py
    def __init__(self, input_channels, d_model, n_state):
        super(BiMambaConcatEncoder, self).__init__()
        self.d_model = d_model
        ...
        self.ff_in = nn.Linear(input_channels, d_model)
        self.feed_forward = nn.Sequential(
    ...
    def forward(self, x):
        ...
        # Combining forward and backward
        mamba_out = torch.cat((mamba_out_forward, mamba_out_backward), dim=2)
