...
update:
	./../login.sh
	fmle-cli e update dd1916cc-6faf-4c13-8616-12a26294abaf --docker-image "10.252.13.191:5000/bdsw/vladimir.vincan.ivi/mamba:0.1" --script-entry-point "physionet/run.sh" physionet
	fmle-cli e t launch train.yaml
update2:
	./login.sh
